  ...
  return (
    <ProtectedLayout>
      <div className="mb-8">
        ...
        <p className="text-primary-muted mt-1 font-medium">Manage your inventory items</p>
      </div>
      <div className="p-12 rounded-2xl border border-dashed border-border bg-surface/50 text-center">
        <p className="text-primary-muted">Products management coming in the next step...</p>
      </div>
    </ProtectedLayout>
  );
}
